...
- 🖥️ **Interfaz Interactiva**: Menú intuitivo con 10 opciones de análisis
...
6. **EXPORTAR RESULTADOS A JSON** - Exporta resultados a formato JSON
7. **VISUALIZAR GRÁFICOS** - Genera gráficos de evolución temporal
8. **GENERAR REPORTE HTML/MARKDOWN** - Crea reportes profesionales
...
│   ├── visualizacion.rs        # Generación de gráficos ASCII
